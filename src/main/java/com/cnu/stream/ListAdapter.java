...
public class ListAdapter extends BaseAdapter {
    ...
    Context context;
    public ListAdapter(Context context, List<String> songNames, List<String> thumbnails, List<String> songArtist, List<String> songDuration, List<String> songGenre) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.songGenre.setText(songGenre.get(i));
        return view;
    }
